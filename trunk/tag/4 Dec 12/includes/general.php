...
function rightSideBar(){
    ...
    $db = new Database();
	$newRecipes = $db->select('Recipe','ID,name,uploadDate','1','','uploadDate LIMIT 0,10');
...
echo <<<EOF
        ...
        <div id="searchBar" class="column-2">
            <div class="column-2-1" style="text-align: center">
                ...
                <br>
                <ul id="menu">
                    <li><a href="index.php">Home</a></li><li><a href="upload.php">Upload A Recipe</a></li>
EOF;
    if (isset($_SESSION["userName"]) == FALSE)
        echo "<li><a href='register.php'>Register Now</a></li>";
    else
        echo "<li><a href='userhome.php'>Account Home</a></li>";
