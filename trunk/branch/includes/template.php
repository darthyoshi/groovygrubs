...
EOF;
    ...
    echo <<<EOF
            ...
            <div style='font-size: large'>&nbsp; Your latest <a href='viewlist.php?type=favorite'>favorites</a>:</div>
    ...
    echo <<<EOF
        ...
        <div id="searchBar" class="column-2">
            <div class="column-2-1" style="text-align: center">
                <label for="search">Search for recipes now!</label>
                <form id="searchForm" action="search.php" method="GET" style="margin-left: 50px">
                    ...
                    <button type="submit">Search</button>
					 <div style="font-size: small; position: relative; right: 30px">
                        Search by:
                        <input type="radio" name="searchType" value="title" checked="checked" id="title"/><!--
						--><label for="titleName">title</label>
                        <input type="radio" name="searchType" value="ingredientsName" id="ingredientsName"/><!--
                        --><label for="ingredientsName">ingredients</label>
                    </div>
                </form>
